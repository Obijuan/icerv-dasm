...
impl InstructionRV {
    ...
    pub fn to_mcode(&self) -> u32 {
        match self {
            ...
            Self::Lui {rd, imm} => {
                //-- Construir el código máquina
                let mcode = MCode::new_lui(*rd as u32, *imm as u32);
            ...
            Self::Jalr {rd, offs, rs1} => {
                //-- Construir el código máquina
                let mcode = MCode::new_typej_jalr(
                    *rd as u32, *rs1 as u32, *offs);
...
fn test_instruction_and() {
    assert_eq!(
        InstructionRV::And{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_string(), 
        "and x0, x1, x2");
    assert_eq!(
        InstructionRV::And{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_string(), 
        "and x3, x4, x5");
    assert_eq!(
        InstructionRV::And{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_string(), 
        "and x6, x7, x8");
    assert_eq!(
        InstructionRV::And{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_string(), 
        "and x9, x10, x11");
    assert_eq!(
        InstructionRV::And{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_string(), 
        "and x12, x12, x14");
    assert_eq!(
        InstructionRV::And{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_string(), 
        "and x15, x16, x17");
    assert_eq!(
        InstructionRV::And{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_string(), 
        "and x18, x19, x20");
    assert_eq!(
        InstructionRV::And{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_string(), 
        "and x21, x22, x23");
    assert_eq!(
        InstructionRV::And{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_string(), 
        "and x24, x25, x26");
    assert_eq!(
        InstructionRV::And{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_string(), 
        "and x27, x28, x29");
    assert_eq!(
        InstructionRV::And{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_string(), 
        "and x30, x31, x31");
}
...
fn test_mcode_and() {
    ...
    assert_eq!(
        InstructionRV::from_mcode(0x0020f033).to_string(), 
        "and x0, x1, x2");
     assert_eq!(
...
fn test_mcode2_lbu() {
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X0, offs: 0, rs1: Reg::X1}.to_mcode(), 
        0x0000c003);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X1, offs: 1, rs1: Reg::X2}.to_mcode(), 
        0x00114083);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X2, offs: 2, rs1: Reg::X3}.to_mcode(),
        0x0021c103);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X4, offs: 4, rs1: Reg::X4}.to_mcode(),
        0x00424203);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X5, offs: 8, rs1: Reg::X5}.to_mcode(),
        0x0082c283);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X6, offs: -1, rs1: Reg::X6}.to_mcode(),
        0xfff34303);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X7, offs: -2048, rs1: Reg::X7}.to_mcode(),
        0x8003c383);
    assert_eq!(
        InstructionRV::Lbu{rd: Reg::X8, offs: -2, rs1: Reg::X8}.to_mcode(),
        0xffe44403);
    assert_eq!(
...
fn test_mcode2_lwu() {
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X0, offs: 0, rs1: Reg::X1}.to_mcode(), 
        0x0000e003);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X1, offs: 1, rs1: Reg::X2}.to_mcode(), 
        0x00116083);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X2, offs: 2, rs1: Reg::X3}.to_mcode(), 
        0x0021e103);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X4, offs: 4, rs1: Reg::X4}.to_mcode(), 
        0x00426203);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X5, offs: 8, rs1: Reg::X5}.to_mcode(), 
        0x0082e283);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X6, offs: -1, rs1: Reg::X6}.to_mcode(),
        0xfff36303);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X7, offs: -2048, rs1: Reg::X7}.to_mcode(),
        0x8003e383);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X8, offs: -2, rs1: Reg::X8}.to_mcode(),
        0xffe46403);
    assert_eq!(
        InstructionRV::Lwu{rd: Reg::X9, offs: 2047, rs1: Reg::X9}.to_mcode(),
        0x7ff4e483);
}
...
fn test_mcode2_add() {
    assert_eq!(
        InstructionRV::Add{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x00208033);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(),
        0x005201b3);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(),
        0x00838333);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(),
        0x00b504b3);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e60633);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011807b3);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x01498933);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b0ab3);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01ac8c33);
    assert_eq!(
        InstructionRV::Add{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de0db3);
    assert_eq!(
...
fn test_mcode2_sll() {
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x00209033);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(), 
        0x005211b3);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(), 
        0x00839333);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(), 
        0x00b514b3);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e61633);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011817b3);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x01499933);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b1ab3);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01ac9c33);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de1db3);
    assert_eq!(
        InstructionRV::Sll{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x01ff9f33);
}
...
fn test_mcode2_slt() {
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x0020a033);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(),
        0x005221b3);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(),
        0x0083a333);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(),
        0x00b524b3);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e62633);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011827b3);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x0149a933);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b2ab3);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01acac33);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de2db3);
    assert_eq!(
        InstructionRV::Slt{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x01ffaf33);
}
...
fn test_mcode2_xor() {
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x0020c033);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(), 
        0x005241b3);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(),
        0x0083c333);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(),
        0x00b544b3);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e64633);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011847b3);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x0149c933);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b4ab3);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01accc33);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de4db3);
    assert_eq!(
        InstructionRV::Xor{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x01ffcf33);  
}
...
fn test_mcode2_srl() {
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(),
        0x0020d033);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(),
        0x005251b3);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(),
        0x0083d333);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(),
        0x00b554b3);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e65633);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011857b3);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x0149d933);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b5ab3);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01acdc33);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de5db3);
    assert_eq!(
        InstructionRV::Srl{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x01ffdf33);
}
...
fn test_mcode2_sra() {
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x4020d033);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(), 
        0x405251b3);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(), 
        0x4083d333);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(), 
        0x40b554b3);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(), 
        0x40e65633);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(), 
        0x411857b3);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x4149d933);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x417b5ab3);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x41acdc33);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x41de5db3);
    assert_eq!(
        InstructionRV::Sra{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x41ffdf33);
}
...
fn test_mcode2_or() {
    assert_eq!(
        InstructionRV::Or{rd: Reg::X0, rs1: Reg::X1, rs2: Reg::X2}.to_mcode(), 
        0x0020e033);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X3, rs1: Reg::X4, rs2: Reg::X5}.to_mcode(), 
        0x005261b3);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X6, rs1: Reg::X7, rs2: Reg::X8}.to_mcode(),
        0x0083e333);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X9, rs1: Reg::X10, rs2: Reg::X11}.to_mcode(),
        0x00b564b3);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X12, rs1: Reg::X12, rs2: Reg::X14}.to_mcode(),
        0x00e66633);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X15, rs1: Reg::X16, rs2: Reg::X17}.to_mcode(),
        0x011867b3);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X18, rs1: Reg::X19, rs2: Reg::X20}.to_mcode(),
        0x0149e933);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X21, rs1: Reg::X22, rs2: Reg::X23}.to_mcode(),
        0x017b6ab3);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X24, rs1: Reg::X25, rs2: Reg::X26}.to_mcode(),
        0x01acec33);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X27, rs1: Reg::X28, rs2: Reg::X29}.to_mcode(),
        0x01de6db3);
    assert_eq!(
        InstructionRV::Or{rd: Reg::X30, rs1: Reg::X31, rs2: Reg::X31}.to_mcode(),
        0x01ffef33);
}
...
fn test_mcode2_sb() {
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X0, offs: 0, rs1: Reg::X1}.to_mcode(), 
        0x00008023);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X2, offs: -1, rs1: Reg::X3}.to_mcode(), 
        0xfe218fa3);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X4, offs: 2047, rs1: Reg::X5}.to_mcode(), 
        0x7e428fa3);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X5, offs: -2048, rs1: Reg::X6}.to_mcode(), 
        0x80530023);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X6, offs: 2, rs1: Reg::X7}.to_mcode(),
        0x00638123);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X8, offs: 4, rs1: Reg::X9}.to_mcode(),
        0x00848223);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X10, offs: 8, rs1: Reg::X11}.to_mcode(),
        0x00a58423);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X12, offs: 16, rs1: Reg::X13}.to_mcode(),
        0x00c68823);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X14, offs: 32, rs1: Reg::X15}.to_mcode(),
        0x02e78023);
      assert_eq!(
        InstructionRV::Sb{rs2: Reg::X16, offs: 64, rs1: Reg::X17}.to_mcode(),
        0x05088023);
}
...
fn test_mcode2_sh() {
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X0, offs: 0, rs1: Reg::X1}.to_mcode(), 
        0x00009023);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X2, offs: -1, rs1: Reg::X3}.to_mcode(), 
        0xfe219fa3);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X4, offs: 2047, rs1: Reg::X5}.to_mcode(),
        0x7e429fa3);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X5, offs: -2048, rs1: Reg::X6}.to_mcode(),
        0x80531023);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X6, offs: 2, rs1: Reg::X7}.to_mcode(),
        0x00639123);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X8, offs: 4, rs1: Reg::X9}.to_mcode(),
        0x00849223);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X10, offs: 8, rs1: Reg::X11}.to_mcode(),
        0x00a59423);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X12, offs: 16, rs1: Reg::X13}.to_mcode(),
        0x00c69823);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X14, offs: 32, rs1: Reg::X15}.to_mcode(),
        0x02e79023);
    assert_eq!(
        InstructionRV::Sh{rs2: Reg::X16, offs: 64, rs1: Reg::X17}.to_mcode(),
        0x05089023);
}
...
fn test_mcode2_beq() {
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X0, rs2: Reg::X0, offs: 0}.to_mcode(), 
        0x00000063); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X1, rs2: Reg::X2, offs: -4}.to_mcode(),
        0xfe208ee3); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X3, rs2: Reg::X4, offs: -8}.to_mcode(),
        0xfe418ce3); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X5, rs2: Reg::X6, offs: -12}.to_mcode(),
        0xfe628ae3); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X7, rs2: Reg::X8, offs: 24}.to_mcode(),
        0x00838c63); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X9, rs2: Reg::X10, offs: 20}.to_mcode(),
        0x00a48a63); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X11, rs2: Reg::X12, offs: 16}.to_mcode(),
        0x00c58863); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X13, rs2: Reg::X14, offs: 12}.to_mcode(),
        0x00e68663); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X15, rs2: Reg::X16, offs: 8}.to_mcode(),
        0x01078463); 
    assert_eq!(
        InstructionRV::Beq {rs1: Reg::X17, rs2: Reg::X18, offs: 4}.to_mcode(),
        0x01288263); 
}
...
fn test_mcode2_bne() {
    assert_eq!(
        InstructionRV::Bne{rs1: Reg::X0, rs2: Reg::X0, offs: 0}.to_mcode(), 
        0x00001063);
    assert_eq!(
...
fn test_mcode2_blt() {
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X0, rs2: Reg::X0, offs: 0}.to_mcode(), 
        0x00004063);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X1, rs2: Reg::X2, offs: -4}.to_mcode(),
        0xfe20cee3);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X3, rs2: Reg::X4, offs: -8}.to_mcode(),
        0xfe41cce3);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X5, rs2: Reg::X6, offs: -12}.to_mcode(),
        0xfe62cae3);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X7, rs2: Reg::X8, offs: 24}.to_mcode(),
        0x0083cc63);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X9, rs2: Reg::X10, offs: 20}.to_mcode(),
        0x00a4ca63);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X11, rs2: Reg::X12, offs: 16}.to_mcode(),
        0x00c5c863);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X13, rs2: Reg::X14, offs: 12}.to_mcode(),
        0x00e6c663);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X15, rs2: Reg::X16, offs: 8}.to_mcode(),
        0x0107c463);
    assert_eq!(
        InstructionRV::Blt{rs1: Reg::X17, rs2: Reg::X18, offs: 4}.to_mcode(),
        0x0128c263); 
}
...
fn test_mcode2_bge() {
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X0, rs2: Reg::X0, offs: 0}.to_mcode(),
        0x00005063);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X1, rs2: Reg::X2, offs: -4}.to_mcode(),
        0xfe20dee3);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X3, rs2: Reg::X4, offs: -8}.to_mcode(),
        0xfe41dce3);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X5, rs2: Reg::X6, offs: -12}.to_mcode(),
        0xfe62dae3);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X7, rs2: Reg::X8, offs: 24}.to_mcode(),
        0x0083dc63);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X9, rs2: Reg::X10, offs: 20}.to_mcode(),
        0x00a4da63);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X11, rs2: Reg::X12, offs: 16}.to_mcode(),
        0x00c5d863);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X13, rs2: Reg::X14, offs: 12}.to_mcode(),
        0x00e6d663);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X15, rs2: Reg::X16, offs: 8}.to_mcode(),
        0x0107d463);
    assert_eq!(
        InstructionRV::Bge{rs1: Reg::X17, rs2: Reg::X18, offs: 4}.to_mcode(),
        0x0128d263); 
}
...
fn test_mcode2_bgeu() {
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X0, rs2: Reg::X0, offs: 0}.to_mcode(), 
        0x00007063);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X1, rs2: Reg::X2, offs: -4}.to_mcode(),
        0xfe20fee3);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X3, rs2: Reg::X4, offs: -8}.to_mcode(),
        0xfe41fce3);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X5, rs2: Reg::X6, offs: -12}.to_mcode(),
        0xfe62fae3);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X7, rs2: Reg::X8, offs: 24}.to_mcode(),
        0x0083fc63);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X9, rs2: Reg::X10, offs: 20}.to_mcode(),
        0x00a4fa63);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X11, rs2: Reg::X12, offs: 16}.to_mcode(),
        0x00c5f863);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X13, rs2: Reg::X14, offs: 12}.to_mcode(),
        0x00e6f663);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X15, rs2: Reg::X16, offs: 8}.to_mcode(),
        0x0107f463);
    assert_eq!(
        InstructionRV::Bgeu{rs1: Reg::X17, rs2: Reg::X18, offs: 4}.to_mcode(),
        0x0128f263); 
}
...
fn test_mcode2_jalr() {
    assert_eq!(
        ...
        0x00000067);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X1, offs: -1, rs1: Reg::X10}.to_mcode(), 
        0xfff500e7);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X2, offs: -2, rs1: Reg::X11}.to_mcode(), 
        0xffe58167);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X3, offs: -4, rs1: Reg::X12}.to_mcode(), 
        0xffc601e7);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X4, offs: -8, rs1: Reg::X13}.to_mcode(), 
        0xff868267);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X5, offs: -2048, rs1: Reg::X14}.to_mcode(), 
        0x800702e7);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X6, offs: 2047, rs1: Reg::X15}.to_mcode(), 
        0x7ff78367);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X7, offs: 16, rs1: Reg::X16}.to_mcode(), 
        0x010803e7);
    assert_eq!(
        InstructionRV::Jalr{rd: Reg::X8, offs: 8, rs1: Reg::X17}.to_mcode(), 
        0x00888467);
    assert_eq!(
